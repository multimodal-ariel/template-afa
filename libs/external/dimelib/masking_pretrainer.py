...
from .utils import generate_uniform_mask


class MaskingPretrainModule(pl.LightningModule):
    """
    ...
    def __init__(
        ...
        # book keeping for validation steps
