...
# %%
tdata, vdata, tstdata = mydatasets.aaco.load_aaco_data("ct-slice-rel-loc")
...
# %%
model_xgb_arb = xgbst.XGBClassifier(random_state=29, n_jobs=-1)
model_xgb_arb.fit(data_x_train, data_y_train)

# %%
# Save the model
model_xgb_arb.save_model("ct-slice-rel-loc_xgb_classifier_arb_subsets.json")
