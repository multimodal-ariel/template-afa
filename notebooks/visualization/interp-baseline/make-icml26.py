...
files_d: dict[str, str] = {
    # "big5": "",
    "blah1": "notebooks/visualization/interp-baseline/baseline/gas.csv",
    "gas": "notebooks/visualization/interp-baseline/baseline/gas.csv",
    "grid": "notebooks/visualization/interp-baseline/baseline/grid.csv",
    "mnist-ds": "notebooks/visualization/interp-baseline/baseline/mnist.csv",
    # "fashion-ds": "",
    "blah2": "notebooks/visualization/interp-baseline/baseline/grid.csv",
    # cube
    "blah3": "notebooks/visualization/interp-baseline/baseline/grid.csv",
}
...
for (_title, _metrics_df), _ax in zip(metrics_d.items(), axs):
    ...
    for _method in ["ensemble", "sympol", "ddt"]:
...
fig.savefig("interp-baseline.png", dpi=720, bbox_inches="tight")
