...
plf: pl.Fabric = pl.Fabric(loggers=[tfb_logger, csv_logger], accelerator="auto")
metrics_func = thm.MetricCollection(
    {
...
tstate = _TrainState(
    rplbuf=thrl_data.ReplayBuffer(
        storage=thrl_data.ListStorage(max_size=1_000_000),
...
# tstate["opt"] = hd.utils.instantiate(cfg.dagger_nnet_tcfg.opt, params=nnet.parameters())
