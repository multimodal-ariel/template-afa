...
# %%
tmpls: th.Tensor = tafalib.makers.templates.make_vanilla_gradient_descent_templates(
    tdata=tdata,
    max_tdata=max_tdata,
    classifier=tclassifier,
    ...
    n_tdata_minibatch=len(tdata) if max_tdata is None else max_tdata,
    n_cands_minibatch=n_cands_targ,
