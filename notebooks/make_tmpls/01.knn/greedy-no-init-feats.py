...
output_dir: str = os.path.join(
    "outputs", "run", data_name, "greedy-posthoc-init-fidx-cnnet"
)
...
#     init_fidx=tafalib.makers.templates.post_hoc_count_based_identify_init_fidx,
...
tmpls = tafalib.makers.templates.make_templates_vanilla(
    ...
    classifier=tclassifier,
    to_update_classifier=True,
    init_fidx=tafalib.makers.templates.post_cost_try_then_identify_init_fidx,
    n_tmpls=n_tmpls_targ,
    n_cands=n_cands_targ,
    min_features=1,
    max_features=max_features_targ,
