...
def make_templates_direct_greedy(
    ...
    for _itr in pbar:
        ...
        for _tidx in range(_ntmpls):
            ...
            # given tidx-th template, for each possible location, add one additional feature to tidx-th template
...
output_dir: str = os.path.join("outputs", "run", data_name, "direct-greedy")
